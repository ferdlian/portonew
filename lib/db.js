...
async function applyMigrations() {
  ...
  for (const migration of migrations) {
    ...
    // Split SQL by semicolon for batch processing as Turso might prefer individual statements or specific transactional approach
    // But Turso's execute() handles multiple statements if they are valid SQL.
    // However, to be safe and consistent with previous sync version:
    await client.batch([
      migration.sql,
      {
